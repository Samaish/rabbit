package com.andev.browser.Activity;
...
import com.andev.browser.Service.HolderService;
...
public class BrowserActivity extends Activity implements BrowserController {
    ...
    private ImageView omniboxBookmark;
    ...
    private ImageButton main_omnibox_back;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tooltips = new ToolTipManager(BrowserActivity.this);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_VOLUME_UP) {
            ...
            if(webView!= null&&webView.canGoBack())
            {
                ...
                main_omnibox_back.setVisibility(View.GONE);
            }
...
//    CustomProgress customProgress;
    private void initOmnibox() {
        ...
        omniboxBookmark = (ImageView) findViewById(R.id.main_omnibox_bookmark);

        omniboxRefresh = (ImageButton) findViewById(R.id.main_omnibox_refresh);
        main_omnibox_back = (ImageButton) findViewById(R.id.main_omnibox_back);
...
main_omnibox_back.setOnClickListener(new View.OnClickListener() {
    @Override
        ...
        inputBox.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(internetConnection==false)
                {
                    updateAlbum();
                    hideSoftInput(inputBox);
                    Toast.makeText(BrowserActivity.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
                    return false;
                }
...
//                ObjectAnimator anim = ObjectAnimator.ofFloat(main_omnibox_back, "rotation", 0f, 90f);
...
//                anim.start();
                main_omnibox_back.setVisibility(View.VISIBLE);
                updateAlbum(query);
                hideSoftInput(inputBox);
                return false;
            }
...
//                showOverflow();
    ...
    private void showpopupwindows(final Activity context, Point p) {
        ...
        View layout = layoutInflater.inflate(R.layout.tooltip_list, viewGroup);
...
//        popup.setAnimationStyle(R.style.WindowAnimation);
        ...
        ListView listView = (ListView) layout.findViewById(R.id.simpleListView);
...
//        return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
        return Environment.getExternalStoragePublicDirectory("/Incognito Browser");
    }
    public void init_modal_bottomsheet() {
        View modalbottomsheet = getLayoutInflater().inflate(R.layout.bottom_sheet_dialog, null);
        ((ImageView)modalbottomsheet.findViewById(R.id.btnExit)).setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
    onBackPressed();
    }
        ...
        ( (ImageView)modalbottomsheet.findViewById(R.id.btnSetting)).setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        Intent intent = new Intent(BrowserActivity.this, SettingActivity.class);
        startActivity(intent);
        ...
        modalbottomsheet.findViewById(R.id.btnHide).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        modalbottomsheet.findViewById(R.id.btnForward).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //you can use isShowing() because BottomSheet inherit from Dialog class
                if (dialog.isShowing()){
                ...
                {
                    Toast.makeText(BrowserActivity.this, "Can not go forward", Toast.LENGTH_SHORT).show();
                }

            }
        });
        modalbottomsheet.findViewById(R.id.btnDownlaod).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //you can use isShowing() because BottomSheet inherit from Dialog class
                if (dialog.isShowing()){
...
openDownloads(BrowserActivity.this);
            }
        });
        modalbottomsheet.findViewById(R.id.btnFindinPage).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //you can use isShowing() because BottomSheet inherit from Dialog class
        ...
        modalbottomsheet.findViewById(R.id.btnRefresh).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private synchronized void addAlbum(int flag) {
        ...
        if (flag == BrowserUnit.FLAG_BOOKMARKS) {
            ...
            NinjaRelativeLayout layout=null;
            boolean internetConnection = InternetConnection.checkConnection(BrowserActivity.this);
            if(internetConnection==false)
            {
            layout = (NinjaRelativeLayout) getLayoutInflater().inflate(R.layout.no_internet, null, false);

          layout.findViewById(R.id.btnSetings).setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View view) {
            ...
            {
                layout = (NinjaRelativeLayout) getLayoutInflater().inflate(R.layout.home, null, false);
...
ArrayList<WebView> arrWebViews=new ArrayList<>();
...
public static int searchEngineType=0;
    ...
    public void onBackPressed() {
        ...
        if(webView.canGoBack())
        {
            ...
            Toast.makeText(this, webView.getAlbumTitle(), Toast.LENGTH_SHORT).show();
        }
        else {
            main_omnibox_back.setVisibility(View.GONE);
        }
